...
public enum DomainEvent {
    ...
    TEXTBOOK_CONTENT_MODIFIED("textbook.content_modified", TextbookContentModifyInput.class, List.class),
    ...
    EXERCISE_CREATED("exerciseAnswer.created", ExerciseCreateInput.class, Exercise.class),
    EXERCISE_UPDATED("exerciseAnswer.updated", ExerciseUpdateInput.class, Exercise.class),
    EXERCISE_CONTENT_MODIFIED("exerciseAnswer.content_modified", ExerciseModifyContentInput.class, List.class),
    ...
    EXERCISE_ANSWER_UPDATED("exercise_answer.updated", ExerciseAnswerUpdateInput.class, ExerciseAnswer.class),

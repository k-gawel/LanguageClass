...
class ExerciseEvaluationCreator {
    ...
    @Autowired
    ExerciseEvaluationCreator(ExerciseEvaluationRepository repository, ExerciseContentRepository contentRepository, QuestionEvaluationRepository questionEvaluationRepository) {

...
class FillAWordFacade implements FillAWordService {
    ...
    @Autowired
    FillAWordFacade(QuestionContentCreator questionContentCreator, QuestionAnswerCreator questionAnswerCreator, ExerciseContentCreator exerciseCreator, ExerciseAnswerCreator exerciseAnswerCreator, QuestionEvaluationCreator evaluationCreator) {
